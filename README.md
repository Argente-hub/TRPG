...
| 资料库 | 资源库随规则书版本切换:3.25 版 1593 条,RM 版 1672 条(总纲分支嵌套于总纲条目内,不再单列)+ 拆分后 12110 个可独立购买的技能/部件(5783 个带等级门槛)与 823 个等级阶梯(共 3717 级,含 1672 个无标价等级;分支内部阶梯亦可逐级购买);搜索/筛选/详情/一键挂载;技能树技能与阶梯等级可逐级"购买并挂载"(自动校验并扣减支线/分数并记录流水);支持外部资源导入 |
