...
| 资料库 | 资源库随规则书版本切换:3.25 版 1593 条,RM 版 1721 条 + 拆分后 5945 个可独立购买的技能/部件与 409 个等级阶梯(共 1686 级,1959 个带等级门槛);搜索/筛选/详情/一键挂载;技能树技能与阶梯等级可逐级"购买并挂载"(自动校验并扣减支线/分数并记录流水);支持外部资源导入 |
